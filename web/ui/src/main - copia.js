...
let urlOnlyOffice = "http://" + _ambiente_.CFG_SERVICIOS_URL + ":" + _ambiente_.CFG_ONLYOFFICE_PORT + "/web-apps/apps/api/documents/api.js";
...
if ( (ruta == "formulario") && (formularios.indexOf(formulario) > -1) ) {
    ...
    window.sessionStorage.setItem("usuario", JSON.stringify({
        ...
        dependencia_id: "037723cf-cdd3-11eb-b888-acfdce646f0d",
        //dependencia_id: "330fc2a6-1035-11ec-be73-acfdce646f0d",
        dependencia_nombre: "financiera",
        id: '39d612d6-acff-11eb-b928-006073b60f8a',
        nombre: "ALFREDO MARTINEZ-JEFE",
        reemplaza_id: null,
