...
let grupoRadicado = forma_objeto.grupo_objeto({
    'titulo'     : 'Radicado Entrada información',    
...
let tramiteItems = [
    ...
    forma_objeto.campo_objeto({
        'campo'      : 'dependencia_inicial',
        'titulo'     : 'Dependencia',     
        'editable'   : 'no',         
    }),

    forma_objeto.campo_objeto({
        'campo'      : 'responsable_inicial',
        'titulo'     : 'Responsable',  
        'editable'   : 'no'            
    }),
]
...
let grupoTramite = forma_objeto.grupo_objeto({
    'titulo'     : 'Radicado Entrada tramite',    
...
let definicion = {
    ...
    "titulo"       : "Información del Radicado Entrada",
    'campos'       : campos,
    //'ajustaPalabra': 'si',
    //'lectura'   : 'si',
    'columnas'  : 2,
    ...
    "metodos"   : {
        "cambiaDatosEvento": function(forma, datos) {
            ...
            let gridAnexo       = window.$ns["entradas_ventanilla_archivos_anexos"]             
