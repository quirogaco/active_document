...
let tercero_generales = function(forma) {
    return forma_definiciones.grupo(
        ...
        {
            "elementos": [            
                tercero_definiciones.tipo_tercero_id(null, { forma: forma, filtros_fuente: ["tipo", "=", "JURIDICA"], eventos: {}, titulo:"Tipo de entidad"}),
                tercero_definiciones.razon_social(null, {forma: forma}),
                tercero_definiciones.nro_identificacion(null, {forma: forma, obligatorio:true, titulo:"Nit"}),
