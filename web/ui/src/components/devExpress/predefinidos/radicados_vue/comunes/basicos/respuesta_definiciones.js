    ...
    let atributos_base = {
        ...
        "eventos": {
            "seleccion_cambiada": function(campo, definicion, forma, forma_id) {  
                ...
                forma_definiciones.limpia_campos(
                    forma, 
        ...
        "eventos": {
            "valor_cambiado": function(campo, definicion, forma, forma_id) {
                ...
                if ( valor.indexOf("CORREO") > -1 ) {
                    forma_definiciones.asigna_validador_forma(
                        forma, 
                    ...
                    forma_definiciones.borra_validador_forma(forma, 
                        ["tercero_correo_electronico"], 
                        "obligatorio"
                    )
                }
                ...
                if ( valor.indexOf("DIRECCION") > -1 ) {
                    ...
                    forma_definiciones.borra_validador_forma(
                        forma, 
                        ["tercero_direccion"], 
                        "obligatorio"
                    )
