...
let metodos = {
    montado_especifico: function(basicas) {
        ...
        datos.datos["radicado"]["es_pqrs"] = 
            datos.datos["radicado"]["clase_radicado"];
        datos.datos["radicado"]["gestion_peticion_id"] = ""; 
        datos.datos["radicado"]["gestion_dependencia_id"] = "";
        datos.datos["radicado"]["gestion_dependencia_id"] = "";
        datos.datos["radicado"]["gestion_total_tiempo"] = "";
    ...
    retorna_remoto: function(retorna) {
        ...
        this.$router.push("grid_ventanilla_asigna_grid")
    },
