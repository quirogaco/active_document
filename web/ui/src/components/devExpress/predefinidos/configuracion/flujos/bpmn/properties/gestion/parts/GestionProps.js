...
export default function (element, translate) {
    ...
    return [
        gestion_dias_asignados({ element: element }, translate),
...
// TRASLADO Y GESTIÓN //
//********************//
function gestion_dias_asignados(props, translate) {
    let field = entryFactory.textBox(translate, {
        id           : "gestion_dias_asignados",
        label        : "Dias asignados?",
        modelProperty: "gestion_dias_asignados"
    })
