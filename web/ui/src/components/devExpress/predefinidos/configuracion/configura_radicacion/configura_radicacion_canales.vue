<template src="./configura_radicacion_canales.html">
</template>
...
import configura_radicacion_canales_definiciones from "./configura_radicacion_canales_definiciones.js"

let configura_radicacion =  {
    name: 'configura_radicacion_canales',
    ...
    methods: configura_radicacion_canales_definiciones.metodos,
    ...
    data() {
        return {                
            ...
            // Barra de acciones
            barra_botones: configura_radicacion_canales_definiciones.barra_botones(this)        
        }
    }
}
