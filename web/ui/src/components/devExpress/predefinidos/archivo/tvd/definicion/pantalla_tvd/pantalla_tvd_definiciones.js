let metodos = {
    retorna: function(retorna) {
        ...
        if (accion=="borrar_tvd") {
            this.$router.push("tvd_basica_grid")         
        }
    },
    ...
    boton_click(e) {
        ...
        switch (boton) {
            case 'crear': 
                parametros["accion"] = "crear_tvd"
                break;

            case 'modificar':  
                parametros["accion"] = "modificar_tvd"              
                break;
            
            case 'borrar':      
                parametros["accion"] = "borrar_tvd"              
                break;
