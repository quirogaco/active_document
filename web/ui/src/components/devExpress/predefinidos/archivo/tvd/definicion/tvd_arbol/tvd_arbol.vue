...
import metodos        from './tvd_arbol_metodos.js'
import botones_accion from './tvd_arbol_atributos.js'

import ventana_emergente_tvd from './ventana_emergente_tvd/ventana_emergente_tvd.vue'
...
export default {
    ...
    mounted() {
        ...
        setTimeout(() => {
            let datos     = window.$pantalla_tvd.parametros.tvd_datos.tvd_arbol
            this.tvd_data = datos
        }, 2000);
        this.notify = notify        
    },
