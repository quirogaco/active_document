let metodos = {
    ...
    boton_click(e) {
        ...
        switch (boton) {
            case 'crear': 
                parametros["accion"] = "crear_transferencia"
                break;

            case 'modificar':  
                parametros["accion"] = "modificar_transferencia"              
                break;
            
            case 'borrar':      
                parametros["accion"] = "borrar_transferencia"              
                break;

            case 'regresar':       
                enviar = false         
                this.$router.push("transferencia_basica_grid")
                break;
        }
