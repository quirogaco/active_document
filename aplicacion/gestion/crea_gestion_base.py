...
def crea_registro_gestion(datos, archivos, id_tarea):
    ...
    detalle        = "ASIGNACI�N POR COMPETENCIA A " + dependencia["pqrs_nombre"] + ", DE " + dependencia["nombre_completo"]
    ...
    # Log de creaci�n registro gesti�n
    datos_log = {
