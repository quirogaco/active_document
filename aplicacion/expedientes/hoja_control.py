...
def crear_excel_base( datos ):  
    ...
    columnas        = [
        ...
        {
            'campo' : 'tipo_detalle',
            'titulo': 'TIPO DOCUMENTAL / DESCRIPCIÓN',
            'ancho' : '40'
        },
    ...
    worksheet.write( 'B2', "HOJA DE CONTROL PARA EXPEDIENTES DE ARCHIVO DE GESTIÓN ", bold )
...
def imprimir_control(accion, datos={}, archivo=[], id_tarea=""):
