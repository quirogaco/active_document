...
campos = {
    ...
    "archivo_origen"  : tipos.clave_obligatorio(propiedades={"titulo": "Expediente id", "longitud": 60, "defecto": "TRD"}), 
    ...
    "renovaciones"     : tipos.entero(propiedades={"titulo": "Nómero de renovaciones"}), 
}
...
definicion = {
    "descripcion" : "Prestamo de expediente",
    "clase"       : "agn_prestamos_trd",
