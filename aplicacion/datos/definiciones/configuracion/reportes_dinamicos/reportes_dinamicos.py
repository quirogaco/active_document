...
campos = {
    ...
    "diseno": tipos.json(propiedades={"titulo": "Configuración del reporte", "defecto": 'json'}), 
}

definicion = {
    "descripcion" : "Definición de Reportes Dinamicos",
    "clase"       : "config_reportes_dinamicos",
    "estructura"  : "reportes_dinamicos",    
    "campos"      : campos,
    "referencias" : [],
    "campoIndice" : "id",
    "indexa"      : "si",
