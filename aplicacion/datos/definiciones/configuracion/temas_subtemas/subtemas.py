...
campos = {
    ...
    "tema_id"    : tipos.clave_obligatorio(propiedades={"titulo": "Tema", "longitud": 60}),   
    "tema_nombre": tipos.texto(propiedades={"columna": "no", "titulo": "Tema", "longitud": 250, "reporte": "SI"}), 
}

referencias = [
    {
        "campoReferencia"    : "tema_id", 
        "atributosReferencia": [{
            "tema_nombre": "nombre",
        }],            
...
definicion = {
    "descripcion" : "Subtemas por tema",
    "clase"       : "config_subtemas",
    "estructura"  : "subtemas",    
    "campos"      : campos,
