...
# resultado = elastic_operaciones.eliminaIndice("empresas_mensajeria", "base")
# resultado = elastic_operaciones.eliminaIndice("motivos_devolucion", "base")
...
#resultado = elastic_operaciones.eliminaIndice("datos_formularios_dinamicos", "base")
