...
modelo    = globales.lee_modelo_elastic("internos_ventanilla")
...
for limite in range(0, 140000, 1000):
    print(desde, limite)    
    resultado = sqalchemy_operaciones.leer_todos("base", "internos_ventanilla", extendido=True, desde=desde, hasta=limite)
