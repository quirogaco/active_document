...
modelo    = globales.lee_modelo_elastic("entradas_ventanilla")
...
for limite in range(0, 140000, 5000):
    print(desde, limite)    
    resultado = sqalchemy_operaciones.leer_todos("base", "entradas_ventanilla", extendido=True, desde=desde, hasta=limite)
